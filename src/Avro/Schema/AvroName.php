 ...
 * Class AvroName
 */
class AvroName implements AvroNameInterface
{
     ...
     * @throws AvroSchemaParseException if any of the namespace components are invalid.
     */
     ...
     * @param $name
     *
     * @return bool true if the given name is well-formed (is a non-null, non-empty string) and false otherwise
     */
