...
require_once __DIR__ . '/SchemaExample.php';
...
class SchemaTest extends TestCase
{
    ...
    ', true)];
        ...
        $unionExamples = [
            ...
            new SchemaExample('[{"type": "array", "items": "long"}{"type": "array", "items": "string"}]', false),
            new SchemaExample('["long",{"type": "long"},"int"]', false),
    ...
    ',
        ...
        $fixedExamples = [
            ...
            new SchemaExample('{"type": "fixed", "name": "Missing size"}', false),
            new SchemaExample('{"type": "fixed", "size": 314}', false),
            new SchemaExample(
        ...
        $fixedExamples [] = new SchemaExample(
        ...
        $fixedExamples [] = new SchemaExample('{"type":"fixed","name":"baz.3x","size":4}', false);

        $enumExamples = [
            new SchemaExample('{"type": "enum", "name": "Test", "symbols": ["A", "B"]}', true),
            new SchemaExample('{"type": "enum", "name": "Status", "symbols": "Normal Caution Critical"}', false),
            new SchemaExample(
                '{"type": "enum", "name": [ 0, 1, 1, 2, 3, 5, 8 ], "symbols": ["Golden", "Mean"]}',
                false
            ),
            new SchemaExample('{"type": "enum", "symbols" : ["I", "will", "fail", "no", "name"]}', false),
            new SchemaExample('{"type": "enum", "name": "Test" "symbols" : ["AA", "AA"]}', false),
            new SchemaExample('{"type":"enum","name":"Test","symbols":["AA", 16]}', false),
            new SchemaExample(
                '{"type": "enum", "name": "blood_types", "doc": "AB is freaky.", "symbols" : ["A", "AB", "B", "O"]}',
                true
            ),
            new SchemaExample('
    {"type": "enum",
...
', false);
    ...
    public function testJsonDecode()
    {
        ...
        self::assertFalse(is_array(json_decode('null', true)));
        self::assertEquals(json_decode('{"type": "null"}', true), ["type" => 'null']);
        self::assertEquals(json_decode('"boolean"'), 'boolean');
    }
     ...
     * @param $example
     */
    public function testParse($example)
    {
    ...
    public function testRecordDoc()
    {
        ...
        $bar = $fields[0];
        self::assertEquals($bar->getDoc(), "Bar doc.");
    }
